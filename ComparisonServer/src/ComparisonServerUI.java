...
public class ComparisonServerUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        collectionPathField.setText("/Users/sam/Desktop/lia.meetlucene/ServerText");

        toIndexPathField.setText("/Users/sam/Desktop/lia.meetlucene/ServerIndex");
        toIndexPathField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                toIndexPathFieldActionPerformed(evt);
            }
        });
        ...
        collectionNameTextField.setText("Collection");
        ...
        jLabel3.setText("Indexed Directory Path");

        jLabel4.setText("Port to Open");
        ...
        searchIndexedButton.setText("Search");
        searchIndexedButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchIndexedButtonActionPerformed(evt);
            }
        });
        ...
        comparisonPanelLayout.setHorizontalGroup(
            ...
            .addGroup(comparisonPanelLayout.createSequentialGroup()
                ...
                .addGroup(comparisonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(comparisonPanelLayout.createSequentialGroup()
                        .addComponent(indexedPathField, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(searchIndexedButton))
                    .addGroup(comparisonPanelLayout.createSequentialGroup()
                        .addGroup(comparisonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        comparisonPanelLayout.setVerticalGroup(
            ...
            .addGroup(comparisonPanelLayout.createSequentialGroup()
                .addGroup(comparisonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(indexedPathField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(searchIndexedButton))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(comparisonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(comparisonPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 663, Short.MAX_VALUE)
    ...
    private void searchIndexedButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchIndexedButtonActionPerformed
        // TODO add your handling code here:
        ...
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            indexedPathField.setText(dirName);
        }
    }//GEN-LAST:event_searchIndexedButtonActionPerformed
    ...
    private void openServerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openServerButtonActionPerformed
        ...
        if (myLibrary != null) {
            ...
            //String indexPath = indexedPathField.getText();

            try {
                serverMessageField.setText("Attempting to initialize server");
                ServerCommunication myServer = new ServerCommunication(port,
                    myLibrary, listModel);
                serverMessageField.setText("Connected to client");
                
                myServer.communicate();
                
                ArrayList<Double> products = myServer.getProducts();
                
                /*
                double topProduct = myServer.getTopProduct();
                DecimalFormat df = new DecimalFormat("#.###");
                serverMessageField.setText("Most similar document score: " +
                    df.format(topProduct));
                */
                
                
            } catch (Exception ex) {
                serverMessageField.setText("Server connection failed; try again.");
    ...
    private void toIndexPathFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_toIndexPathFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_toIndexPathFieldActionPerformed
    ...
    public void LuceneIndex(String indexDir, String dataDir) throws Exception {
        ...
        indexedPathField.setText(toIndexPathField.getText());
    }
    ...
    //private Dictionary myWords = null;
    ...
    private javax.swing.JTextField indexedPathField;
    ...
    private javax.swing.JButton searchIndexedButton;
